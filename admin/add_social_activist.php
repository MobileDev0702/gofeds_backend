...
if(isset($_POST['submit'])){
	...
	if($query){
		echo '<script>alert("Social Activist Added Successfully!");
        window.location.href="view_social_activist.php"
        </script>';
		
	}else{
		echo '<script>alert("Error to Add Social Activist.");
        window.location.href="add_social_activist.php"
        </script>';
	}
}
?>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Add Social Activist</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        ...
                        <div class="m-t-20 text-center">
                            <button name="submit" class="btn btn-primary submit-btn">Add Social Activist</button>
                        </div>
                    </form>
                </div>
            </div>
