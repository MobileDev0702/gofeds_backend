...
include("include/connection.php"); 
    $query = mysqli_query($conn, "select * from bn_problems where status='Active' ");
    ...
    if($_REQUEST['del_id']){
        ...
        window.location.href="view_active_problems.php"
        </script>';
        }else{
            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">All Active Problems List</h4>
                    </div>
										...
										<td class="text-right">
											<div class="dropdown dropdown-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
													...
													<a class="dropdown-item" href="view_active_problems.php?del_id=<?php echo $data['problem_id']; ?>"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
												</div>
											</div>
										</td>
									</tr>
