...
include("include/connection.php"); 
    $query = mysqli_query($conn, "select * from bn_problems ");
            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">All Problems List</h4>
                    </div>
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add_problem.php" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Problem</a>
                    </div>
                </div>
				<div class="row">
							...
							<table class="table table-border table-striped custom-table datatable mb-0">
								...
								<tbody id="myTable">
								    <?php 
                    					...
                    					$query_cat = mysqli_query($conn, "select name from bn_category where id='".$data['problem_category']."' ");
                        					$data_cat = mysqli_fetch_array($query_cat);
                                    ?>
									<tr>
									    <td><?php echo $a; ?></td>
									    <!--<td><?php //echo $data_user['name']; ?></td>-->
										<td><?php echo $data_cat['name']; ?></td>
										...
										<td class="text-right">
											<div class="dropdown dropdown-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
													...
													<a class="dropdown-item" href="view_problems.php?del_id=<?php echo $data['problem_id']; ?>"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
												</div>
											</div>
										</td>
									</tr>
