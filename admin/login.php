    ...
    <div class="main-wrapper account-wrapper">
        <div class="account-page">
			<div class="account-center">
			    <div style="text-align: center;"><!--<img src="http://missindoasia.com/admin/assets/img/logomiss.png" style="margin-bottom: 8px;" height="80" width="80">--> <span style="font-size: 30px;color: goldenrod; padding:10px;">Gofeed</span></div>
